...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<RobotPattern *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (RobotPattern::*)(VarType * );
...
QT_INIT_METAOBJECT const QMetaObject CMPattern::RobotPattern::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_CMPattern__RobotPattern.data,
    qt_meta_data_CMPattern__RobotPattern,
    qt_static_metacall,
    nullptr,
    nullptr
} };
